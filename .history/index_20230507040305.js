...
const playerInput = () => {
  ...
  const inputTrimLower = input ? input.trim().toLowerCase() : null;
  if (inputTrimLower === null) {
    return;
  } else if (inputTrimLower === "") {
    alert("Selection cannot be empty");
    playerInput();
  } else if (
    inputTrimLower === "rock" ||
    inputTrimLower === "paper" ||
    inputTrimLower === "scissors"
  ) {
    return inputTrimLower;
  } else {
