...
const winner = () => {
  ...
  console.log(`%cFinal score: %c${result} %cPlayer: %c${playerScore} %c| Computer: %c${computerScore} %c| Tie: %c${tie}`, "font-size: 14px; font-weight: bold;", `color: ${color}; font-size: 18px; font-weight: bold;`, "font-size: 14px; font-weight: bold;", "color: #007bff; font-size: 18px; font-weight: bold;", "font-size: 14px; font-weight: bold;", "color: #dc3545; font-size: 18px; font-weight: bold;", "font-size: 14px; font-weight: bold;", "color: #28a745; font-size: 18px; font-weight: bold;");
};
...
const game = () => {
  ...
  // const [resultText, resultColor] = winner();
// console.log(result, color);

  // console.log(
  //   `%cFinal score: ${resultText, resultColor} \n %cPlayer: %c${playerScore}%c | Computer: %c${computerScore}%c | Tie: %c${tie}%c`,
